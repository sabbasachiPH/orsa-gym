...
const Train = () => {
  return (
    <div id="services" className="container trainingContainer">
      <h2 className="text-center trainingHead">
        TRAINING <span className="text-yellow">PROGRAMS</span>
      </h2>
      <div className="row">
        <div className="col-md-6 ">
          <img src={img1} alt="" />
          <a className="trainLink" href="/class-description/YOGA-TRAINING">
        ...
        <div className="col-md-6 ">
          <img src={img2} alt="" />
          <a className="trainLink" href="/class-description/CARDIO-TRAINING">
